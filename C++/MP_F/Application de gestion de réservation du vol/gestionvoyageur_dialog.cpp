    ...
    ui(new Ui::GestionVoyageur_Dialog)
{
    ...
    QMovie* movie1 = new QMovie("./Data/Pictures/gif3.gif");
    QLabel* label_gif1 = new QLabel(this);
    label_gif1->setMovie(movie1);
    int w4 = ui->label_gif1->width();
    int h4 = ui->label_gif1->height();
    int x4 = ui->label_gif1->x();
    int y4 = ui->label_gif1->y();
    label_gif1->setScaledContents(true);
    QSize my_size = QSize(w4, h4);
    label_gif1->resize(my_size);
    label_gif1->move(x4,y4);
    movie1->start();
