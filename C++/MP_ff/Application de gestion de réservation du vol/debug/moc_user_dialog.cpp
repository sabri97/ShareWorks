...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_User_Dialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 83, 15)
    ...
    "User_Dialog\0myfunction\0\0on_load_clicked\0"
    "on_advancedSearch_clicked\0on_Valid_clicked\0"
    "on_save_clicked\0"
};
...
void User_Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_advancedSearch_clicked(); break;
        case 3: _t->on_Valid_clicked(); break;
...
const QMetaObject User_Dialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_User_Dialog.data,
      qt_meta_data_User_Dialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_User_Dialog.stringdata))
