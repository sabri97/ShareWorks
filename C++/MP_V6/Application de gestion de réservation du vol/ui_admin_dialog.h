...
public:
    ...
    void setupUi(QDialog *Admin_Dialog)
    {
        ...
        gestionVol = new QPushButton(tab_4);
        gestionVol->setObjectName(QStringLiteral("gestionVol"));
        gestionVol->setGeometry(QRect(230, 130, 101, 23));
        gestionVoyageur = new QPushButton(tab_4);
        gestionVoyageur->setObjectName(QStringLiteral("gestionVoyageur"));
        gestionVoyageur->setGeometry(QRect(220, 180, 101, 23));
        ...
        label_background2->setGeometry(QRect(5, 0, 961, 501));
